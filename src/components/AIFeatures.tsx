...
export default function AIFeatures() {
    ...
    const aiFeatures = [
        { title: f.image.title, description: f.image.description, icon: "🎨", accent: "primary" as const, href: "/ai-image-generator" },
        { title: f.text.title, description: f.text.description, icon: "✍️", accent: "secondary" as const, href: "/ai-text-generator" },
        { title: f.chat.title, description: f.chat.description, icon: "💬", accent: "primary" as const, href: "/chat-bot" },
        { title: f.video.title, description: f.video.description, icon: "🎬", accent: "tertiary" as const, href: "/ai-video-generator" },
        { title: f.music.title, description: f.music.description, icon: "🎵", accent: "secondary" as const, href: "/ai-music-generator" },
    ];
