...
export default function Pricing() {
    ...
    const plans = isAnnual ? t.pricing.annualPlans : t.pricing.monthlyPlans;
        ...
        <section id="pricing" className="py-24 lg:py-32 bg-slate-50 dark:bg-[#0B1120] bg-grid">
            <div ref={ref} className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div className="fade-up fade-up-delay-3 mt-14 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    {plans.map((plan: { name: string; description: string; features: readonly string[] }, i: number) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div>
                                    <h3
                                        className={`text-lg font-bold ${highlighted ? "text-primary" : "text-[#0F172A] dark:text-[#F8FAFC]"
                                            }`}
                                    >
                                        {plan.name}
                                    </h3>
