const en = {
    ...
    hero: {
        badge: "Global Digital AI-gency",
        titleLine1: "Build Smarter Brands.",
        titleLine2: "Faster.",
    ...
    aiFeatures: {
        ...
        servicesTitle: "Digital Strategies That Drive Growth",
        services: {
            cloud: {
    ...
    blog: {
        ...
        title: "AI & Digital Growth Insights",
        description:
            "Articles on AI, digital agency, mobile apps, CRM, and marketing strategy to help businesses grow faster.",
        all: "All",
        empty: "No articles in this category yet.",
        readSuffix: "read",
        backToBlog: "Back to Blog",
        relatedTitle: "Related Articles",
        ctaTitle: "Ready to grow your business with AI?",
        ctaDescription:
            "plus. helps brands build digital, AI, and creative strategy in one integrated platform.",
        ctaButton: "View Our Plans",
    },
};
